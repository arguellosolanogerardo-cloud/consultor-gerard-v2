...
if not st.session_state.user_name:
    ...
    st.markdown('<div style="text-align:center; margin-top:8px;"><span style="color:rgb(0, 19, 28); font-weight:bold; font-size:2.5em;">TU NOMBRE</span></div>', unsafe_allow_html=True)
