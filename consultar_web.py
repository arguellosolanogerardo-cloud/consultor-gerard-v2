...
def check_faiss_exists_wrapper():
...
def load_resources():
    ...
    setup_faiss_cloud.check_faiss_exists()
...
def format_docs_with_metadata(docs: Iterable[Any]) -> str:
    ...
    for doc in docs_list:
        ...
        source_filename = doc.metadata.get('source', 'Desconocido')
...
st.title("🔬 GERARD v3.01 - Sistema de Análisis Investigativo (Gemini 1.5 Flash)")
...
if query:
    st.info("Procesando tu consulta con Gemini 1.5 Flash...")
