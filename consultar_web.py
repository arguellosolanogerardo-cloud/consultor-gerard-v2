...
if st.session_state.get('show_verification', False):
    st.header("🔍 Verificación de Google Sheets")

    # Botón para cerrar la verificación
    if st.button("❌ Cerrar Verificación", key="close_verification"):
    ...
    if st.button("Probar Conexión con Google Sheets", key="test_connection"):
        try:
            ...
            test_row = [
                ...
                "TEST_CLOUD_INTEGRADO",
                "test_user",
                "¿Funciona el registro integrado?",
                "Sí, funciona correctamente desde la app principal",
                "Cloud",
                "Streamlit",
                "Web",
                "Test City",
